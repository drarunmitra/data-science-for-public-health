...
author: "![](aiims_bibinagar_logo.png){width=300}<br><br>**Dr. Arun Mitra Peddireddy** <br>Dept of Community and Family Medicine,<br>All India Institute of Medical Sciences (AIIMS), Hyderabad<br><br><a href= 'mailto: name@email.com'> dr.arunmitra@gmail.com </a>"
format: 
  revealjs:
    slide-number: true
...
![](images/1.JPG){fig-align="center" height="700"}

### State Dashboard

![](images/home.JPG){fig-align="center" height="700"}
...
plots <- read_rds("plots/state_district_epidemic_curves_dygraphs.rds")
...
plots <- read_rds("plots/r0_districts_plot.rds")
...
![](images/population_mobility.JPG){fig-align="center" height="700"}
...
:::: {.column width="70%"}
![](images/12.JPG){fig-align="center"}
...
![](images/9.JPG){fig-align="center" height="700"}


### Patterns


![](images/11.JPG){fig-align="center" height="700"}
...
**_Transforming COVID-19 testing data into actionable evidence for public health decision-making using epidemiological, spatiotemporal, and data-science methods_**
...
![](images/eficon2023_certificate.png){fig-align="center" height="700"}
...
:::: {.column width="35%"}
![](images/eficon2023_poster_001.png){fig-align="center" height="700"}
...
![](images/urban_rural_ridge_plot.png){fig-align="center" height="700"}

### Varying Trends

![](images/animation2.gif){fig-align="center" height="700"}

### Spatial Clustering

![](images/ohsa_cs_overall_nfhs5.png){fig-align="center" height="700"}

### Public *vs* Private

![](images/ohsa_public_private.png){fig-align="center" height="700"}
:::
...
![](images/stroke_access_1.png){fig-align="center" height="700"}


### Regional Disparities

![](images/regional_disparities.png){fig-align="center" height="700"}
...
- Geographic Data Science: [https://geographicdata.science/book/intro.html](https://geographicdata.science/book/intro.html) (its in python, by the concepts are language agnostic)

- Spatial Data Science with R and `terra`: [https://rspatial.org](https://rspatial.org)
